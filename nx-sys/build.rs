...
pub fn regen_bindings(
    input: &str,
    output: &str,
    whitelist: Option<Vec<String>>,
) -> Result<bindgen::Bindings, std::io::Error> {
...
pub fn process_bindgen(input: &str, output: &str, name: &str, whitelist: Option<Vec<String>>) {
    regen_bindings(input, output, whitelist)
        .expect(&format!("Error generating {}'s bindings!", name));
}
