...
impl LibraryApplet {
    ...
    pub fn push_data(&mut self, data: *const u8, size: u64) -> os::Result<()> {
        unsafe {
            let rc = ::libnx::libappletPushInData(
                &mut self.holder,
    ...
    pub fn pop_data(&mut self, out: *mut u8, size: u64) -> os::Result<u64> {
        unsafe {
